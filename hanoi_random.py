# Hanoi tower (M plates, N poles), at each step takes one of all possible moves randomly, for T moves
# calculate the mean/std of the final position of the mass center of all plates
